...
from _shared.utils.database import appointment_db
...
async def lifespan(app: FastAPI):
    ...
    try:
        await appointment_db.create_schema()
...
async def readiness_check():
    ...
    try:
        ...
        async with appointment_db.async_session_maker() as session:
