...
from _shared.utils.database import workshop_db
...
async def lifespan(app: FastAPI):
    ...
    try:
        await workshop_db.create_schema()
...
async def readiness_check():
    ...
    try:
        ...
        async with workshop_db.async_session_maker() as session:
